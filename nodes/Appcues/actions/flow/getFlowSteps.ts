...
export async function getFlowSteps(
	...
	const responseData = await appcuesApiRequest.call(this, 'GET', `/flows/${flowId}/steps`);

	const results = Array.isArray(responseData) ? responseData : responseData.steps || [responseData];
